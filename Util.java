public class Util
{
	...
	* Author 	  : Ryan May
	* Section	  : CSC111-302
	* Program Description: This method takes a full formatted name
	*				and reformats to a desired length of characters
	*				by cutting characters off the end of the string.
	*				If the full formatted name is shorter than the desired
	*				length, this method will append spaces on the end
	*				until it is desired length.
	*
